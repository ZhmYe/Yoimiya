...
func (b *BlueprintGenericSparseR1C) NewUpdateInstructionTree(inst Instruction, tree InstructionTree, iID int, cs *System) {
	NewupdateInstructionTree(inst.Calldata[0:3], tree, iID, cs)
}
...
func (b *BlueprintSparseR1CMul) NewUpdateInstructionTree(inst Instruction, tree InstructionTree, iID int, cs *System) {
	NewupdateInstructionTree(inst.Calldata[0:3], tree, iID, cs)
}
...
func (b *BlueprintSparseR1CAdd) NewUpdateInstructionTree(inst Instruction, tree InstructionTree, iID int, cs *System) {
	NewupdateInstructionTree(inst.Calldata[0:3], tree, iID, cs)
}
...
func (b *BlueprintSparseR1CBool) NewUpdateInstructionTree(inst Instruction, tree InstructionTree, iID int, cs *System) {
	NewupdateInstructionTree(inst.Calldata[0:1], tree, iID, cs)
}
...
func NewupdateInstructionTree(wires []uint32, tree InstructionTree, iID int, cs *System) {
	// constraint has at most one unsolved wire.
