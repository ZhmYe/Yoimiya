...
import (
	...
	bls12377r1cs "Yoimiya/constraint/bls12-377"
	bls12381r1cs "Yoimiya/constraint/bls12-381"
	bls24315r1cs "Yoimiya/constraint/bls24-315"
	bls24317r1cs "Yoimiya/constraint/bls24-317"
	bn254r1cs "Yoimiya/constraint/bn254"
	bw6633r1cs "Yoimiya/constraint/bw6-633"
	bw6761r1cs "Yoimiya/constraint/bw6-761"
	"Yoimiya/constraint/solver"
	tinyfieldr1cs "Yoimiya/constraint/tinyfield"
)
...
// returns in graph into a slice of compiledTerm and the sum of all constants in in as a bigInt
...
// returns in graph into a slice of compiledTerm and the product of all constants in in as a coeff
